...
use paths::{
    cwtools_info_path_check, default_cache_dir, discover_vanilla_dir, lang_display_name,
    line_value_key, logical_path_from_uri, parse_uri, path_to_uri, strip_loc_quotes,
    uri_to_path_str,
};
