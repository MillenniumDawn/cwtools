...
impl LocIndex {
    ...
    pub fn build(service: &LocService, game: Option<Game>) -> Self {
    ...
    pub fn build_scoped(service: &LocService, _game: Option<Game>, langs: Option<&[Lang]>) -> Self {
...
mod tests {
    ...
    fn exists_any_is_case_insensitive() {
        ...
        let idx = LocIndex::build(&svc, Some(Game::Hoi4));
    ...
    fn build_scoped_restricts_missing_check_to_chosen_languages() {
        ...
        let idx = LocIndex::build_scoped(&svc, Some(Game::Hoi4), Some(&[Lang::English]));
